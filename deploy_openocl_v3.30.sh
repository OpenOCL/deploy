...
tar -zcf output/openocl_v3-30_linux_matlab.tar.gz -C ocl_tmp .
rm -rf ./ocl_tmp/Lib
...
tar -zcf output/openocl_v3-30_linux_octave.tar.gz -C ocl_tmp .
rm -rf ./ocl_tmp/Lib
...
tar -zcf output/openocl_v3-30_osx_matlab2014b.tar.gz -C ocl_tmp .
rm -rf ./ocl_tmp/Lib
...
tar -zcf output/openocl_v3-30_osx_matlab.tar.gz -C ocl_tmp .
rm -rf ./ocl_tmp/Lib
...
tar -zcf output/openocl_v3-30_osx_octave.tar.gz -C ocl_tmp .
rm -rf ./ocl_tmp/Lib
...
tar -zcf output/openocl_v3-30_win64_2014b.tar.gz -C ocl_tmp .
rm -rf ./ocl_tmp/Lib
...
tar -zcf output/openocl_v3-30_win64_2016a.tar.gz -C ocl_tmp .
rm -rf ./ocl_tmp/Lib
...
tar -zcf output/openocl_v3-30_win64_octave_4-2-1.tar.gz -C ocl_tmp .
rm -rf ./ocl_tmp/Lib
