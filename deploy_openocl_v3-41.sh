...
mkdir ocl_tmp/Lib
unzip archives_tmp/win64_matlab2014b.zip -d ocl_tmp/Lib
cd ocl_tmp/
zip -r ../output/openocl_v3-41_win64_matlab2014b.zip *
cd ..
rm -rf ./ocl_tmp/Lib
...
mkdir ocl_tmp/Lib
unzip archives_tmp/win64_matlab2016a.zip -d ocl_tmp/Lib
cd ocl_tmp/
zip -r ../output/openocl_v3-41_win64_matlab2016a.zip *
cd ..
rm -rf ./ocl_tmp/Lib
...
mkdir ocl_tmp/Lib
unzip archives_tmp/win64_octave_4-2-1.zip -d ocl_tmp/Lib
cd ocl_tmp/
zip -r ../output/openocl_v3-41_win64_octave_4-2-1.zip *
cd ..
rm -rf ./ocl_tmp/Lib
